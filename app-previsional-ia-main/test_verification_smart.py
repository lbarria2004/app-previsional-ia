...
def test_smart_generation():
    ...
    context_surv = {
        ...
        "profesion_consultante": "PROFESORA",
        "estado_civil_consultante": "SOLTERA",
        "fecha_nacimiento_consultante": "01 de Enero de 1980",
        "beneficiaries": [
    ...
    context_old_age = {
        ...
        "ciudad_afiliado": "SPRINGFIELD CITY",
        "telefono_afiliado": "+56987654321",
        "celular_afiliado": "+56900001111",
        "correo_afiliado": "alberto@ejemplo.com",
        "estado_civil_afiliado": "CASADO",
        "fecha_nacimiento_afiliado": "01 de Enero de 1950",
        "oficio_afiliado": "JUBILADO",
        "afp_origen": "AFP MODELO",
        "sistema_salud": "FONASA",
        "tipo_pension": "VEJEZ EDAD",
        "fecha_actual": datetime.now().strftime("%d de %B de %Y"),
